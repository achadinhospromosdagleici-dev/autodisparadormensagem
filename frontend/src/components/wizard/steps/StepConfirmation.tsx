    ...
    try {
      const response = await campaignService.create({
        ...
        config: {
          ...
          title: (messages[0] as any)?.btnTitle || (messages[0] as any)?.title,
          footer: (messages[0] as any)?.btnFooter || (messages[0] as any)?.footer,
          buttons: (messages[0] as any)?.buttons,
          linkUrl: (messages[0] as any)?.linkUrl,
          sections: (messages[0] as any)?.sections,
          cards: (messages[0] as any)?.cards,
